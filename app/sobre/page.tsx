...
const teamSchema = {
  ...
  mainEntity: {
    ...
    foundingDate: '2024',
    description:
      'Plataforma com mais de 300 guias de estudo, questões reais do INEP (2009–2024) e correção de redação por IA.',
    employee: [
      {
        '@type': 'Person',
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-zinc-700 leading-relaxed mb-3">
            O ENEM Pro existe para democratizar a preparação de qualidade. Reunimos mais de 300
