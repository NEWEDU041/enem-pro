...
export const metadata: Metadata = {
  ...
  description: 'Assine o ENEM Pro e acesse questões ilimitadas do ENEM 2009–2024 com explicação por IA em cada resposta. Plano Pro por R$29,90/mês. Cancele quando quiser.',
  alternates: { canonical: `${SITE_URL}/planos` },
  openGraph: {
    title: 'Planos ENEM Pro — Pro R$29,90/mês',
