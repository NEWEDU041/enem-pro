...
function SetupScreen({
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-zinc-900 mb-2">Modo Simulado</h2>
      ...
      <div className="bg-white rounded-2xl border border-zinc-200 p-8 space-y-6">
        <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {([10, 20, 45] as const).map((n) => (
              ...
              >
                {n} questões
                <div className={`text-xs font-normal mt-1 ${qCount === n ? 'text-indigo-100' : 'text-zinc-400'}`}>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div>
            <label htmlFor="simulado-ano" className="block text-sm font-semibold text-zinc-700 mb-2">Ano</label>
            <select id="simulado-ano" value={year} onChange={(e) => setYear(parseInt(e.target.value))}
          ...
          <div>
            <label htmlFor="simulado-disciplina" className="block text-sm font-semibold text-zinc-700 mb-2">Disciplina</label>
            <select id="simulado-disciplina" value={discipline} onChange={(e) => setDiscipline(e.target.value)}
              className="w-full border border-zinc-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
function FinishedScreen({ answers, totalTime, onRestart }: {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-zinc-900 mb-2">Resultado do Simulado</h2>
